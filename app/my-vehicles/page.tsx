      ...
      <Table>
        ...
        <TableBody>
          {rentals.map((rental) => {
            ...
            // console.log(rental)
            const { id: vehicleId, make, model, year, price } = rental
            ...
            return (
              <TableRow key={vehicleId}>
                ...
                <TableCell className='flex items-center gap-x-2'>
                  <Link href={`my-vehicles/${vehicleId}/edit`}>
                    <IconButton actionType='edit'></IconButton>
                  </Link>
                  <DeleteRental vehicleId={vehicleId} />
                </TableCell>
              </TableRow>
            )
          })}
...
function DeleteRental({ vehicleId }: { vehicleId: string }) {
  const deleteRental = deleteRentalAction.bind(null, { vehicleId })
  return (
